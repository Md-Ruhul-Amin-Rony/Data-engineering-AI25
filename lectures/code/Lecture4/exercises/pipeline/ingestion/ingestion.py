...
DB_SETTINGS = {
    ...
    "port": 5432,                              # the port INSIDE the network
...
@app.get("/")
def read_root():
    return {"try": "/ingestion?location=Stockholm&date=2026-08-16"}
...
def ingestion(location: str, date: str):
    ...
    # weatherapi.com calls the date parameter `dt`, format YYYY-MM-DD.
    # forecast.json covers today and roughly the next 14 days; for past dates
    # you need the history.json endpoint instead.
