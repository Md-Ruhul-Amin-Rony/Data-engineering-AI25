...
> **Done the [warm-up examples](../lecture-2-examples/README.md)?** Do those
> first if you have not built an image before — they take 20 minutes total.
...
When this works, continue with the hard one:
[**Lecture 2.1 — Docker Compose hands-on**](../lecture-2-compose/README.md) —
FastAPI + Postgres, a CSV ingested on startup, and your first multi-service
system.
